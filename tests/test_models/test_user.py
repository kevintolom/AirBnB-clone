...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_args_unused(self):
        us = User(None)
OBOB        self.assertNotIn(None, us.__dict__.values())

OBOBOBOB    def test_instantiation_with_kwargs(self):
OBOB        dt = datetime.today()
OBOB        dt_iso = dt.isoformat()
...
class TestUser_save(unittest.TestCase):
    ...
    def setUp(self):
        try:
OBOB            os.rename("file.json", "tmp")
        except IOError:
OBOB            pass

OBOB    def tearDown(self):
OBOB        try:
OBOB            os.remove("file.json")
